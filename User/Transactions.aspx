<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Transactions.aspx.cs" Inherits="User_Transactions" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Touch & View | Transactions</title>
...
<body>
    <form id="transactions" runat="server">
            ...
            <ContentTemplate>
                <div id="body">
                    <div class="status">
                        ...
                        <asp:Label ID="status" runat="server" Text="View Transactions"></asp:Label>
                        ...
                        <div class="gvContainer">
                            <asp:GridView ID="gvHistory" CssClass="gv" runat="server" AutoGenerateColumns="False">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Descrption" ItemStyle-CssClass="gvitem" HeaderStyle-CssClass="gvheader">
                                        <ItemTemplate>
