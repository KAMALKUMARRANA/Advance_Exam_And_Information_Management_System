...
public partial class User_Transactions : System.Web.UI.Page
{
    ...
    public void gvHistoryLoad(string userId)
    {
        ...
        using (SqlConnection con = new SqlConnection(cs))
        {
            ...
            cmd.Connection = con;
            cmd.CommandText = "select * from tblUserBalanceHistory where UserId = @UserId order by CONVERT(date, TxnDate , 105) DESC";
